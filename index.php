...
header("Location: https://ezyfx.la/cny2018/./$str");
exit();
}
...
<html lang="">
	<head>
		...
		<!-- Seo Meta Tags -->
		<title>EZYFX - Chinese New Year Promo</title>
		...
		<meta property="og:image" content="https://scontent.fkul14-1.fna.fbcdn.net/v/t1.0-1/p200x200/18882200_573322696171444_6174330684669243747_n.png?oh=6bc1130282e53ad48b4af25b0a6cf95c&oe=5B24919E" />
	...
	<body>
		...
		<h3 class="section-heading">Generate A Personalized EZYFX's Chinese New Year Greetings</h3>
		</div>
		<div class="panel-body">
		<form method="post" class="form-inline">
		<p class="para" style="font-size: 1.1em;">Enter your name below to wish your friends and family members a <br><b style="font-size: 1.3em;">"Happy Chinese New Year"</b></p>
		...
		<button type="submit" name="create-wish" class="btn btn-danger">Create Greetings</button>
		</form>
		</div>
		</div>
		</div>
